...
export default function ProcedureGroupingRulesPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setModalOpen(false);
      loadList();
      toast.success(editId ? "Rule Updated" : "Rule Added", <>{editId ? "The" : "A new"} procedure grouping rule, <strong>{form.groupName}</strong>, has been {editId ? "updated" : "added"} successfully.</>);
    } catch (err) {
  ...
  const handleStatusChange = async (row: ProcedureGroupingRuleDto, activeValue: number) => {
    ...
    try {
      ...
      loadList();
      toast.success("Status Updated", <>The status of procedure grouping rule, <strong>{row.groupName}</strong>, has been updated successfully.</>);
    } catch (err) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setDeleteId(null);
      loadList();
      toast.success("Rule Deleted", <>The procedure grouping rule, <strong>{deletedName}</strong>, has been deleted successfully.</>);
    } catch (err) {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      loadList();
      toast.success("Rules Deleted", <>{selectedIds.size} procedure grouping rule(s) have been deleted successfully.</>);
    } catch (err) {
