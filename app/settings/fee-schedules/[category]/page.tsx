              ...
              <div className="mt-4 flex items-center justify-between border-t border-[#E2E8F0] pt-3">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="h-9 rounded-[5px] border border-[#E2E8F0] bg-background px-4 font-aileron text-[13px] text-[#202830] hover:text-[#0066CC] hover:border-[#0066CC] transition-colors focus:outline-none focus:text-[#0066CC] focus:border-[#0066CC]"
                  >
                    Cancel
                  </button>
                </div>
