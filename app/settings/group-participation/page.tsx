              ...
              <TableBody>
                {data.items.filter((row) =>
                  ...
                  <TableRow key={row.id}>
                    ...
                    <TableCell className="w-[200px] min-w-[200px]">
                      <div className="max-w-xs truncate">
                        <CellTooltip text={row.planDisplayName ?? planNameById.get(row.planId) ?? "—"} />
                      </div>
                    </TableCell>
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <select value={form.entityProviderId ?? ""} onChange={(e) => setForm((f) => ({ ...f, entityProviderId: e.target.value }))} className="w-full rounded-[5px] border border-input px-3 py-2 text-sm focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0">
